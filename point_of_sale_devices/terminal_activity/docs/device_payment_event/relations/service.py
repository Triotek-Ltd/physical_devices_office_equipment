"""Relation service seed for device_payment_event."""
...
RELATED_DOCS = [{'doc_id': 'pos_device', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'terminal_session', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'card_authorization_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'payment_intent_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'device/site context from pos_device'}]
