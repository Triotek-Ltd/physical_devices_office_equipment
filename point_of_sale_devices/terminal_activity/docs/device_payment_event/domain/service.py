"""Business-domain service seed for Device Payment Event."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'posting_flow', 'supports_reconciliation': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': True}, 'integration_profile': {'external_sync_enabled': True, 'tracks_external_refs': True}, 'lifecycle_states': ['received', 'normalized', 'linked', 'archived'], 'is_transactional': True}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'posting_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'posting_date': 'posting_date', 'event_time': 'schedule_marker', 'normalized_status': 'status_flag', 'related_pos_device': 'relation_collection', 'related_card_authorization_record': 'relation_collection', 'related_payment_intent_record': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'event_code', 'terminal', 'provider_network_reference'], 'list_columns': ['title', 'reference_no', 'posting_date', 'workflow_state'], 'initial_state': 'received', 'lifecycle_states': ['received', 'normalized', 'linked', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'record': None, 'normalize': None, 'link': None, 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['pos_device', 'terminal_session', 'card_authorization_record', 'payment_intent_record'], 'action_targets': {'record': None, 'normalize': None, 'link': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
