"""Relation service seed for receipt_print_event."""
...
RELATED_DOCS = [{'doc_id': 'pos_device', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'terminal_session', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'device_payment_event', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'terminal/session context from linked docs'}]
