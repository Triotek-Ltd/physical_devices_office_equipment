...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'posting_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'posting_date': 'posting_date', 'event_time': 'schedule_marker'}, 'search_fields': ['title', 'reference_no', 'description', 'event_code', 'terminal', 'related_sale_payment_reference'], 'list_columns': ['title', 'reference_no', 'posting_date', 'workflow_state'], 'initial_state': 'received', 'lifecycle_states': ['received', 'normalized', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'record': None, 'normalize': None, 'archive': 'archived'}}
