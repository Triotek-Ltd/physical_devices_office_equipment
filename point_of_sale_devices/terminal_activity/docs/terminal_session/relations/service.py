"""Relation service seed for terminal_session."""
...
RELATED_DOCS = [{'doc_id': 'pos_device', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'receipt_print_event', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'device_payment_event', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'terminal identity'}, {'description': 'site from pos_device'}]
