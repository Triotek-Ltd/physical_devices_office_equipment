"""Relation service seed for pos_device."""
...
DOC_ID = "pos_device"
RELATED_DOCS = [{'doc_id': 'terminal_session', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'receipt_print_event', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'device_payment_event', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'merchant/site context from payment or operations setup'}]
