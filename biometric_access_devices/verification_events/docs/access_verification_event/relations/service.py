"""Relation service seed for access_verification_event."""
...
RELATED_DOCS = [{'doc_id': 'access_device', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'access_exception_case', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'biometric_check_case', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'device/site context from access_device'}]
