"""Business-domain service seed for Access Exception Case."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'case_flow', 'supports_assignment': True, 'supports_escalation': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': False}, 'integration_profile': {'external_sync_enabled': False}, 'lifecycle_states': ['opened', 'in_review', 'cleared', 'escalated', 'closed', 'archived'], 'is_transactional': False}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'related_access_verification_event': 'relation_collection', 'related_access_device': 'relation_collection', 'related_fraud_review_case': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'case_code', 'source_verification_event', 'exception_type'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'opened', 'lifecycle_states': ['opened', 'in_review', 'cleared', 'escalated', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'assign': 'in_review', 'review': 'in_review', 'clear': None, 'escalate': 'escalated', 'close': 'closed', 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['access_verification_event', 'access_device', 'fraud_review_case'], 'action_targets': {'create': None, 'assign': 'in_review', 'review': 'in_review', 'clear': None, 'escalate': 'escalated', 'close': 'closed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}

class DomainService:
    doc_id = "access_exception_case"
