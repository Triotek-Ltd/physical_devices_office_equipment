"""Relation service seed for access_exception_case."""
...
RELATED_DOCS = [{'doc_id': 'access_verification_event', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'access_device', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'fraud_review_case', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'event'}, {'description': 'device context from linked records'}]
