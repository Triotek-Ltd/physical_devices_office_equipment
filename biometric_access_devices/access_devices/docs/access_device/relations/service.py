"""Relation service seed for access_device."""
...
RELATED_DOCS = [{'doc_id': 'access_verification_event', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'access_exception_case', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'site/access-point context from facilities/security setup'}]
