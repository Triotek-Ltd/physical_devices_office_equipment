"""Business-domain service seed for Access Device."""
...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'active_status': 'status_flag', 'related_access_verification_event': 'relation_collection', 'related_access_exception_case': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'device_code', 'device_type', 'site_entry_point_scope'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'draft', 'lifecycle_states': ['draft', 'provisioned', 'active', 'retired', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'provision': None, 'activate': 'active', 'retire': None, 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['access_verification_event', 'access_exception_case'], 'action_targets': {'create': None, 'provision': None, 'activate': 'active', 'retire': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
