"""Relation service seed for supply_level_snapshot."""
...
RELATED_DOCS = [{'doc_id': 'device_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'maintenance_case', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'device identity from device_record'}]
