"""Business-domain service seed for Supply Level Snapshot."""
...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'posting_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'posting_date': 'posting_date', 'measured_at': 'schedule_marker', 'related_device_record': 'relation_collection', 'related_maintenance_case': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'snapshot_code', 'source_device', 'measured_at'], 'list_columns': ['title', 'reference_no', 'posting_date', 'workflow_state'], 'initial_state': 'active', 'lifecycle_states': ['active', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'record': None, 'review': None, 'archive': 'archived'}}

WORKFLOW_HINTS = {'relation_context': {'related_docs': ['device_record', 'maintenance_case'], 'borrowed_fields': ['device identity from device_record'], 'inferred_roles': ['case owner']}, 'actors': ['case owner'], 'action_actors': {'record': ['case owner'], 'review': ['case owner'], 'archive': ['case owner']}}

SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['device_record', 'maintenance_case'], 'action_targets': {'record': None, 'review': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}

class DomainService:
    doc_id = "supply_level_snapshot"
    archetype = "ledger"
    doc_kind = "ledger"
