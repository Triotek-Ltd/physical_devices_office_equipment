"""Relation service seed for maintenance_case."""
...
RELATED_DOCS = [{'doc_id': 'device_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'device_job_log', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'supply_level_snapshot', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'device'}, {'description': 'site context from device_record'}]
