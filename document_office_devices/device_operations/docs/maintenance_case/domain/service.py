"""Business-domain service seed for Maintenance Case."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'case_flow', 'supports_assignment': True, 'supports_escalation': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': False}, 'integration_profile': {'external_sync_enabled': False}, 'lifecycle_states': ['opened', 'assigned', 'in_progress', 'resolved', 'closed', 'archived'], 'is_transactional': False}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'related_device_record': 'relation_collection', 'related_device_job_log': 'relation_collection', 'related_supply_level_snapshot': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'case_code', 'source_device', 'issue_type'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'opened', 'lifecycle_states': ['opened', 'assigned', 'in_progress', 'resolved', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'assign': 'in_progress', 'repair': None, 'resolve': 'resolved', 'close': 'closed', 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['device_record', 'device_job_log', 'supply_level_snapshot'], 'action_targets': {'create': None, 'assign': 'in_progress', 'repair': None, 'resolve': 'resolved', 'close': 'closed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
