"""Relation service seed for device_assignment."""
...
RELATED_DOCS = [{'doc_id': 'scanner_device', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'scan_event_log', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'device_sync_event', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'device identity from scanner_device'}]
