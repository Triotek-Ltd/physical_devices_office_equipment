"""Relation service seed for scanner_device."""
...
RELATED_DOCS = [{'doc_id': 'scan_event_log', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'device_assignment', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'device_sync_event', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'site/location context from warehouse or operations setup'}]
