"""Relation service seed for device_sync_event."""
...
RELATED_DOCS = [{'doc_id': 'scanner_device', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'device_assignment', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'scan_event_log', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []
