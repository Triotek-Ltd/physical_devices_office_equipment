"""Business-domain service seed for Scan Event Log."""
...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'posting_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'posting_date': 'posting_date', 'event_time': 'schedule_marker', 'related_scanner_device': 'relation_collection', 'related_device_assignment': 'relation_collection', 'related_inventory_movement': 'relation_collection', 'related_pick_list': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'event_code', 'source_scanner', 'event_time'], 'list_columns': ['title', 'reference_no', 'posting_date', 'workflow_state'], 'initial_state': 'received', 'lifecycle_states': ['received', 'normalized', 'linked', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'record': None, 'normalize': None, 'link': None, 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['scanner_device', 'device_assignment', 'inventory_movement', 'pick_list'], 'action_targets': {'record': None, 'normalize': None, 'link': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
