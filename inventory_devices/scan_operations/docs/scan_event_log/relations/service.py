"""Relation service seed for scan_event_log."""
...
RELATED_DOCS = [{'doc_id': 'scanner_device', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'device_assignment', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'inventory_movement', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'pick_list', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'device assignment'}, {'description': 'site context from linked docs'}]
